...
public class PiggyBackTest {
    ...
    public void piggyBackTest() {
        ...
        player1.PlayerChangeMal(mal1, Yut_Grade.개);

        System.out.println("두번째 말이 이동합니다, 개");
        player1.PlayerChangeMal(mal2, Yut_Grade.개);
        ...
        player1.PlayerChangeMal(mal3, Yut_Grade.윷);
    ...
    public void multiPlayerPiggyBackTest () {
        ...
        player1.PlayerChangeMal(p1_mal1, Yut_Grade.개);
        player1.PlayerChangeMal(p1_mal2, Yut_Grade.개);
        ...
        player2.PlayerChangeMal(p2_mal1, Yut_Grade.개);
        player2.PlayerChangeMal(p2_mal2, Yut_Grade.개);
